...
ANNOTATION_CMD="$SCRIPTS_DIR/annotation.sh $VCF_GTPOS_FIL_ANNOT $EXOME_ENRICHMENT $VCFFIL $VCFNOVO $VCFDOUBLEHIT $OUTPUT_DIR $OUTPUT_DIR/variant_calling/variants_gatk/variants $REF_PATH $PED_FILE"
